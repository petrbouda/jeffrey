...
class SessionFinisherIntegrationTest {
    ...
    private static ServerPlatformRepositories createServerPlatformRepositories(MutableClock clock, DataSource dataSource) {
        var provider = new DatabaseClientProvider(dataSource);
        return new JdbcServerPlatformRepositories(provider, clock);
    }
