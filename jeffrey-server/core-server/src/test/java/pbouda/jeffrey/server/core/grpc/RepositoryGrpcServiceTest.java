...
class RepositoryGrpcServiceTest {
    ...
    class ListSessions {
        ...
        void returnsSessionList() throws Exception {
            ...
            when(repoManager.listRecordingSessions(true)).thenReturn(List.of(
                    new pbouda.jeffrey.shared.common.model.repository.RecordingSession(
            ...
            pbouda.jeffrey.server.api.v1.RecordingSession first = response.getSessions(0);
            ...
            pbouda.jeffrey.server.api.v1.RepositoryFile protoFile = first.getFiles(0);
            ...
            pbouda.jeffrey.server.api.v1.RecordingSession second = response.getSessions(1);
    ...
    class GetSession {
        ...
        void returnsSession() throws Exception {
            ...
            pbouda.jeffrey.server.api.v1.RecordingSession session = response.getSession();
    ...
    class DeleteSession {
        ...
        void deletesSessionSuccessfully() throws Exception {
            ...
            verify(repoManager).deleteRecordingSession(
                    SESSION_ID,
                    pbouda.jeffrey.shared.common.model.workspace.WorkspaceEventCreator.MANUAL);
        }
