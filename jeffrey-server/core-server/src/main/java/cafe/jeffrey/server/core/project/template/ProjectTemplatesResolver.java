...
package cafe.jeffrey.server.core.project.template;

import java.util.List;

public class ProjectTemplatesResolver {

    private final ProjectTemplatesLoader projectTemplatesLoader;

    public ProjectTemplatesResolver(ProjectTemplatesLoader projectTemplatesLoader) {
        this.projectTemplatesLoader = projectTemplatesLoader;
    }

    public List<ProjectTemplate> resolve(TemplateTarget templateTarget) {
