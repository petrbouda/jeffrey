...
import pbouda.jeffrey.server.persistence.sql.DuckDBServerPersistenceProvider;
import pbouda.jeffrey.server.persistence.ServerPersistenceProvider;
import pbouda.jeffrey.server.persistence.sql.repository.JdbcGlobalSchedulerRepository;
