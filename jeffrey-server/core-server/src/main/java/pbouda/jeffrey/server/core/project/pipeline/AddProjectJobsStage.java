...
import pbouda.jeffrey.server.core.project.template.ProjectTemplate;
...
import pbouda.jeffrey.server.core.scheduler.JobDefinition;
...
public class AddProjectJobsStage implements Stage<CreateProjectContext> {
    ...
    public CreateProjectContext execute(CreateProjectContext context) {
        ...
        SchedulerRepository schedulerRepository =
                platformRepositories.newProjectSchedulerRepository(projectId);
