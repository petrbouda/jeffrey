...
package pbouda.jeffrey.server.core.project.pipeline;
...
import pbouda.jeffrey.server.persistence.repository.ProjectsRepository;
import pbouda.jeffrey.server.persistence.model.CreateProject;
...
public class CreateProjectStage implements Stage<CreateProjectContext> {
    ...
    public CreateProjectContext execute(CreateProjectContext context) {
        ...
        pbouda.jeffrey.shared.common.model.CreateProject project = context.createProject();
