...
import static pbouda.jeffrey.server.core.manager.jfr.JfrUtils.parseString;

/**
 * Handles {@code jeffrey.Message} events from a JFR streaming repository.
 * Persists each event to the database via {@link MessageRepository}.
 * Uses ON CONFLICT DO NOTHING for replay-safe idempotent inserts.
 */
public class MessageStreamingHandler implements JfrStreamingHandler {
