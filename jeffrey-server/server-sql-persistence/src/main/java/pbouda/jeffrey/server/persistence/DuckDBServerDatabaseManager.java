...
public class DuckDBServerDatabaseManager implements DatabaseManager {
    ...
    public DuckDBServerDatabaseManager() {
        this(DEFAULT_MIGRATIONS_LOCATION);
    }

    public DuckDBServerDatabaseManager(String migrationsLocation) {
