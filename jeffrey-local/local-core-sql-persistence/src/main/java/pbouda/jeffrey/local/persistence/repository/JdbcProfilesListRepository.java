...
public class JdbcProfilesListRepository implements ProfilesListRepository {
    ...
    public JdbcProfilesListRepository(DatabaseClientProvider databaseClientProvider) {
        this.databaseClient = databaseClientProvider.provide(GroupLabel.PROFILES);
    }

    @Override
    public List<ProfileInfo> findAllByProject(String projectId) {
