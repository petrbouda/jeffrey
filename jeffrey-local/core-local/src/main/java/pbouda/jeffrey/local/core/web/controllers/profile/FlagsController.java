...
public class FlagsController {
    ...
    public FlagsController(ProfileManagerResolver resolver) {
        this.resolver = resolver;
    }

    @GetMapping
    public FlagsData getAllFlags(@PathVariable("profileId") String profileId) {
        LOG.debug("Fetching JVM flags");
        return resolver.resolve(profileId).flagsManager().getAllFlags();
    }
}
