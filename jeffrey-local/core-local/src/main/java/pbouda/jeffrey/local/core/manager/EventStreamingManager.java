...
import pbouda.jeffrey.local.core.client.grpc.RemoteEventStreamingClient;
import pbouda.jeffrey.local.core.client.grpc.RemoteEventStreamingClient.EventStreamingSubscription;
import pbouda.jeffrey.local.core.client.grpc.ReplaySubscriptionRequest;
import pbouda.jeffrey.local.core.client.grpc.StreamingCallbacks;
