 ...
 * payloads via the shared Jackson 3 ({@code tools.jackson}) {@link Json#mapper()}
 * so custom serializers (e.g. for {@code Type}, {@code RelativeTimeRange}) apply
 * uniformly at the HTTP boundary. Replaces the JAX-RS {@code JacksonJsonProvider}.
 */
