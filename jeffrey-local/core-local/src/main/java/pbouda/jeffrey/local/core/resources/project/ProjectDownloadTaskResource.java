...
import pbouda.jeffrey.local.core.manager.download.DownloadTask;
import pbouda.jeffrey.local.core.manager.download.DownloadTaskRegistry;
...
import pbouda.jeffrey.local.core.resources.response.DownloadProgressResponse;
import pbouda.jeffrey.local.core.resources.response.DownloadTaskResponse;
