...
import cafe.jeffrey.local.core.manager.download.DownloadProgress;
import cafe.jeffrey.local.core.manager.download.DownloadTask;
import cafe.jeffrey.local.core.manager.download.DownloadTaskRegistry;
...
import cafe.jeffrey.local.core.resources.request.SelectedRecordingsRequest;
import cafe.jeffrey.local.core.resources.response.DownloadProgressResponse;
import cafe.jeffrey.local.core.resources.response.DownloadTaskResponse;
