...
import cafe.jeffrey.local.core.resources.response.InstanceDetailResponse;
import cafe.jeffrey.local.core.resources.response.InstanceResponse;
import cafe.jeffrey.local.core.resources.response.InstanceSessionDetailResponse;
import cafe.jeffrey.local.core.resources.response.InstanceSessionResponse;
import cafe.jeffrey.local.core.resources.response.InstanceStatsResponse;
...
public class RemoteInstancesClient {
    ...
    private static String fromProtoInstanceStatus(cafe.jeffrey.server.api.v1.InstanceStatus status) {
