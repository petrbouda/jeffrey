...
import cafe.jeffrey.local.core.resources.request.AddRemoteServerRequest;
import cafe.jeffrey.local.core.resources.response.RemoteServerResponse;
import cafe.jeffrey.local.persistence.api.RemoteServerInfo;
