...
import cafe.jeffrey.local.core.configuration.SettingDescriptor;
import cafe.jeffrey.local.core.configuration.SettingsMetadata;
import cafe.jeffrey.local.core.manager.SettingsManager;
import cafe.jeffrey.local.core.resources.request.SettingsRequest;
import cafe.jeffrey.local.core.resources.response.SettingsResponse;
