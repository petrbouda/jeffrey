...
package cafe.jeffrey.profile.ai.oql.heap.config;
...
import cafe.jeffrey.profile.ai.oql.heap.service.HeapDumpAnalysisAssistantServiceImpl;
import cafe.jeffrey.profile.ai.oql.heap.service.NoOpHeapDumpAnalysisAssistantService;
...
public class HeapDumpMcpConfiguration {
    ...
    public HeapDumpAnalysisAssistantService heapDumpAnalysisAssistantService(
            ...
            @Value("${jeffrey.local.ai.model:}") String modelName,
