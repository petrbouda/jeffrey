...
/**
 * Externalised Guardian thresholds, bound to the {@code jeffrey.local.guardian.*} property
 * namespace — matches the rest of the jeffrey-local configuration surface
 * ({@code jeffrey.local.ai.*}, {@code jeffrey.local.profile.*}, …).
 * <p>
 ...
 */
@ConfigurationProperties("jeffrey.local.guardian")
