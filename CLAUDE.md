...
│   ├── gemini-extension.json          # Gemini CLI extension — httpUrl, and the skills and agents beside it
...
│   │                                  #   Gemini discovers this directory too, so the first two carry their tool
│   │                                  #   patterns in both spellings; the lead cannot run there (see below)
