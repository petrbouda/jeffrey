...
import cafe.jeffrey.hub.core.activity.ActivityServiceStoppingException;
...
public abstract class GrpcExceptions {
    ...
    public static StatusRuntimeException toStatus(Throwable exception) {
        return switch (exception) {
            ...
            case ActivityServiceStoppingException e ->
            ...
            case JeffreyClientException e -> e.getCode().isNotFound()
