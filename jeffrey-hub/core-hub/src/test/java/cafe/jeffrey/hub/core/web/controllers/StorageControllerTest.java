    ...
    void returnsCachedStorageOverview() {
        StorageOverview overview = new StorageOverview(
                ...
                List.of(new ProjectStorage(
                        ...
                        List.of(
                                new FileTypeUsage(SupportedFile.JFR, 20_000_000_000L, 300),
                                new FileTypeUsage(SupportedFile.HEAP_DUMP_GZ, 5_000_000_000L, 2),
                                new FileTypeUsage(SupportedFile.JVM_LOG, 1_600_000_000L, 30),
                                new FileTypeUsage(SupportedFile.PPROF, 500_000_000L, 10)),
                        List.of(
