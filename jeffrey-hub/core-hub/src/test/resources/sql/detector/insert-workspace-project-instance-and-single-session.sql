...
-- Insert workspace, project, instance, repository and a single session for detector tests
...
VALUES ('session-001', 'repo-001', 'inst-001', 1, 'session-001', '2025-06-15T10:00:00Z', '2025-06-15T10:00:01Z', NULL);
