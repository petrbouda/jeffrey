                    ...
                    <tr v-for="job in filteredJobs" :key="job.jobType">
                        <td>
                            <div class="job-name-cell">
                                <div class="job-icon-box" :class="iconClassFor(job.jobType)">
                        ...
                        <td>
                            <Badge
                                :value="levelLabelFor(job.executionLevel)"
                                :variant="levelVariantFor(job.executionLevel)"
                                size="xs"
                            />
                        </td>
