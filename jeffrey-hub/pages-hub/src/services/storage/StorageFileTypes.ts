...
/**
 * Visual grouping of the backend's SupportedFile types for the
...
/** Keyed by the SupportedFile enum name sent by the backend. */
 ...
 * its own SupportedFile.UNKNOWN, and the breakdown does the same.
 */
