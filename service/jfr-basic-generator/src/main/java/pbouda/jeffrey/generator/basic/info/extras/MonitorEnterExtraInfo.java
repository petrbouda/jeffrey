...
public class MonitorEnterExtraInfo implements ExtraInfoEnhancer {

    private static final Logger LOG = LoggerFactory.getLogger(MonitorEnterExtraInfo.class);

    private final ActiveSettings settings;

    public MonitorEnterExtraInfo(ActiveSettings settings) {
