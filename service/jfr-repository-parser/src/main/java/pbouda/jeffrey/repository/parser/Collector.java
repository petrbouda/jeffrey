...
/**
 * Collector for combining partial results from repository parsing into a final result.
 *
 * @param <PARTIAL> intermediate result type
 * @param <RESULT>  final result type
 */
