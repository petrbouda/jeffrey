...
public class TimeseriesIteratorResolver {
    ...
    public static EventProcessingIterator.Factory resolve(Type type) {
        return switch (type.code()) {
            case EventTypeName.NATIVE_LEAK -> NativeLeakEventProcessingIterator::new;
            default -> RecordingEventProcessingIterator::new;
        };
    }
}
