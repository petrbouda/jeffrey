...
public interface TimeseriesGenerator {
     ...
     *
     * @param iteratorFactory factory that creates an iterator going through the specified source of events.
     ...
     */
    ArrayNode generate(EventProcessingIterator.Factory iteratorFactory, Config config);
     ...
     * @return timeseries data represented in byte-array format.
     */
    ArrayNode generate(EventProcessingIterator.Factory iteratorFactory, Config config, List<Marker> markers);
}
