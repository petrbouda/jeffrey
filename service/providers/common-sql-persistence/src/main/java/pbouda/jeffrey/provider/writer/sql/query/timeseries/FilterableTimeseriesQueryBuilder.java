...
public class FilterableTimeseriesQueryBuilder extends AbstractTimeseriesQueryBuilder {
    ...
    public FilterableTimeseriesQueryBuilder(SQLFormatter sqlFormatter, String profileId, Type eventType, boolean useWeight) {
        super(sqlFormatter, createBaseBuilder(sqlFormatter, profileId, eventType, useWeight), true);
    }

    private static SQLBuilder createBaseBuilder(SQLFormatter sqlFormatter, String profileId, Type eventType, boolean useWeight) {
        return new SQLBuilder()
                .merge(sqlFormatter.eventFields())
