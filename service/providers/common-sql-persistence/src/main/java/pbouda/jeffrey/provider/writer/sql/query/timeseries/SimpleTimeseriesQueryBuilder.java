...
public class SimpleTimeseriesQueryBuilder extends AbstractTimeseriesQueryBuilder {
    ...
    public SimpleTimeseriesQueryBuilder(SQLFormatter sqlFormatter, String profileId, Type eventType, boolean useWeight) {
        super(sqlFormatter, createBaseBuilder(sqlFormatter, profileId, eventType, useWeight), true);
    }

    private static SQLBuilder createBaseBuilder(
            SQLFormatter sqlFormatter, String profileId, Type eventType, boolean useWeight) {
