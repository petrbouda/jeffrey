...
import pbouda.jeffrey.provider.writer.sqlite.JdbcRepositories;
import pbouda.jeffrey.provider.writer.sqlite.SQLiteEventWriter;

import javax.sql.DataSource;
import java.util.Map;

public class DerbyPersistenceProvider implements PersistenceProvider {
