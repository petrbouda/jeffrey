...
import pbouda.jeffrey.controller.model.CreateProfilerRequest;
...
public class ProfileController {
    ...
    @GetMapping("/jfr")
    public List<JfrFile> jfrFiles() {
        return profilesManager.allJfrFiles();
    }

    @PostMapping
    public ProfileInfo createProfile(@RequestBody CreateProfilerRequest request) {
