...
/**
 * This collector is used to collect a single JFR file that is not split into multiple chunks.
 */
public class SingleTimeseriesCollector implements Collector<LongLongHashMap, LongLongHashMap, ArrayNode> {
