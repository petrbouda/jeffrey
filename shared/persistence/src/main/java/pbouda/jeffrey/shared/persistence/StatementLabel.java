...
public enum StatementLabel {
    ...
    BATCH_INSERT_WORKSPACE_EVENTS,
    FIND_EVENTS_BY_WORKSPACE_ID,
    FIND_EVENTS_BY_WORKSPACE_ID_AND_TYPE,
    FIND_EVENTS_BY_WORKSPACE_ID_FROM_CREATED_AT,
    INSERT_EVENT_CONSUMER,
    UPDATE_EVENT_CONSUMER_UPDATE_OFFSET,
    FIND_EVENT_CONSUMER_BY_ID,
    ...
    UPDATE_PROJECT_INSTANCE_HEARTBEAT,
