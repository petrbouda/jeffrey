...
import DownloadTaskClient from '@hubs/services/api/DownloadTaskClient';
import DownloadProgress from '@hubs/services/api/model/DownloadProgress';
...
const startDownload = async (
  ...
  try {
    ...
    const client = new DownloadTaskClient(hubId, workspaceId, projectId);
