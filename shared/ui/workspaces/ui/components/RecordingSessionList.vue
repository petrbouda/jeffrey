...
import ProjectRepositoryClient from '@workspaces/services/api/ProjectRepositoryClient.ts';
...
const repositoryService = computed(
  () => new ProjectRepositoryClient(props.hubId, props.workspaceId, props.projectId)
);
