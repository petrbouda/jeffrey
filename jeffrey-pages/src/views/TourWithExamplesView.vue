          ...
          <div class="content-section">
            ...
            <div class="step-card">
              ...
              <div class="step-content">
                ...
                <p>Open the <code>Recordings</code> page, where the example recordings are pre-loaded. Pick any recording and start the initialization of a new profile.
        ...
        <div class="categories-section">
          <div class="categories-grid">
            ...
            <div class="category-card">
              ...
              <h4>Custom Events</h4>
              <p>
                Application-specific metrics and business logic events. Concretely, this recording contain emitted events from <a href="https://central.sonatype.com/artifact/cafe.jeffrey-analyst/jeffrey-tracing">Jeffrey Tracing</a>:
              </p>
              <ul>
                <li>HTTP Server</li>
