...
-Dlogging.file.name=/tmp/jeffrey/workspaces/uat/jeffrey/instance-1/019f885e-8e69-7d65-8ac7-32a70b92cb94/jeffrey-app.log
...
# The logging.* flags are stock Spring Boot: logging.file.name alone adds the rolling
# file appender, logging.threshold.console keeps the console at INFO while the file takes TRACE
additional-jvm-options = "-Xmx1200m -Xms1200m -XX:+UseG1GC -XX:+AlwaysPreTouch -Dlogging.level.cafe.jeffrey=TRACE -Dlogging.threshold.console=INFO -Dlogging.file.name=<<JEFFREY:CURRENT_SESSION>>/jeffrey-app.log -Dlogging.logback.rollingpolicy.max-file-size=10MB -Dlogging.logback.rollingpolicy.total-size-cap=100MB -Dlogging.logback.rollingpolicy.max-history=2"
      ...
      <div class="docs-content">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td><code>-Xmx1200m ... -Dlogging.file.name=... -Dlogging.logback.rollingpolicy....</code></td>
