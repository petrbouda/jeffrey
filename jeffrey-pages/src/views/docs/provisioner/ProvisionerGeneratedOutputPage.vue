...
-Djeffrey.logging.trace-file.path=/tmp/jeffrey/workspaces/uat/jeffrey/instance-1/019f885e-8e69-7d65-8ac7-32a70b92cb94/jeffrey-app.log`;
...
# Use a '-jvm.log' suffix so Jeffrey recognizes the file as a JVM log artifact.
additional-jvm-options = "-Xmx1200m -Xms1200m -XX:+UseG1GC -XX:+AlwaysPreTouch -Xlog:gc*=debug:file=<<JEFFREY:CURRENT_SESSION>>/gc-jvm.log:time,uptime,level,tags:filecount=3,filesize=20m -Djeffrey.logging.trace-file.path=<<JEFFREY:CURRENT_SESSION>>/jeffrey-app.log"
      ...
      <div class="docs-content">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td><code>-javaagent:...jeffrey-agent.jar=heartbeat.dir=...,app.workspaceId=...,app.sessionId=...</code></td>
              <td><code>agent-path</code> (automatic when the agent JAR resolves; carries the file-based heartbeat directory and the application identity for <code>jeffrey.AppInformation</code> events)</td>
            </tr>
            <tr>
              <td><code>-XX:FlightRecorderOptions=repository=...</code></td>
              <td><code>agent-path</code> (JFR streaming repository inside the session directory)</td>
            </tr>
            <tr>
              <td><code>-Xmx1200m ... -Xlog:gc*=debug:file=... -Djeffrey.logging.trace-file.path=...</code></td>
