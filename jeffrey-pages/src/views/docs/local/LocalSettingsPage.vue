...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      <p>The <strong>Settings</strong> page provides an in-app UI for configuring Jeffrey Local at runtime. Settings are organized into three tabs: AI Configuration, General, and Visualization.</p>

      <DocsCallout type="info">
        <strong>Properties Files vs Settings UI:</strong> The Settings UI changes runtime configuration stored in Jeffrey's local database. For startup options like server port, AI provider keys via secrets, and bootstrap properties, see <router-link to="/docs/local/configuration/application-properties">Application Properties</router-link>.
      </DocsCallout>
