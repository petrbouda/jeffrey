...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <ul>
        <li>Captured text is rendered with <code>String.valueOf</code> and recorded <strong>whole</strong> &mdash; nothing shortens it, so the value a dashboard groups by is the value itself. A value whose <code>toString()</code> throws is recorded as <code>&lt;unavailable&gt;</code>.</li>
