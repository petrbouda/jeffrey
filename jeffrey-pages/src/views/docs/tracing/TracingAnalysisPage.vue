...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <ul>
        <li><strong>Trace bundle</strong> — the span tree with self and inclusive times, the JVM context (pauses that crossed the trace, what each thread waited on), and the ranked why-slow summary. The preamble spells out that self time is an interval merge, and that the critical path assumes children block their parent.</li>
