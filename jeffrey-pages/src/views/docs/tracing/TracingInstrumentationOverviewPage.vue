  ...
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td><router-link to="/docs/tracing/tracer-api/run">run</router-link> / <router-link to="/docs/tracing/tracer-api/call">call</router-link> / <router-link to="/docs/tracing/tracer-api/call#get">get</router-link></td>
            <td><code>jeffrey.TraceSpan</code></td>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td><router-link to="/docs/tracing/tracer-api/run">run</router-link> (side-effecting) / <router-link to="/docs/tracing/tracer-api/call">call</router-link> (value-returning) / <router-link to="/docs/tracing/tracer-api/call#get">get</router-link> (value-returning, nothing checked — the Kotlin form)</td>
          </tr>
          <tr>
