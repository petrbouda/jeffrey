...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <p>When the cache is empty &mdash; a profile created before this behaviour existed, or a run that failed &mdash; the page opens on a <strong>Run Analysis</strong> button and shows a running state while the rules evaluate. A run that flagged nothing caches an empty result and reads as <em>nothing flagged</em>, which is a different thing from a run that never happened.</p>
