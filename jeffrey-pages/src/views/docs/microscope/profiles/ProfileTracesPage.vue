...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <DocsCallout type="info">
        <strong>Cardinality is the guard.</strong> A <code>user.id</code> attribute on sixty thousand spans is legitimate instrumentation, and every breakdown of it — a value list, a heatmap axis — would be eighteen thousand rows of one trace each. Keys past the cap are marked <em>search only</em>: they are offered in the Search Traces builder, marked, and kept out of the breakdown pages' rail entirely — picking one there would open a page that could only report that it will not draw anything. Where a list is the top of a key rather than the whole of it, it says so.
      </DocsCallout>
