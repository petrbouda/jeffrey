...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <p>Promoted spans are ordinary spans everywhere it matters — they count in the trace's span total, appear in the operation's span breakdown ("Socket read" ranks against your own operations), and subtract from their parent's self time — but they are marked apart: drawn solid in their wait category's colour rather than a span-kind pastel, and their detail names the event they came from. The event's own payload (host and port, file path, monitor class, parked class) is right there in the inline detail. A <strong>Blocking ops</strong> toolbar toggle hides them all to read the recorded span structure alone, and the legend's category buttons narrow them one family at a time.</p>
