...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <p>There are three views, and the conditions, the scope and the selected key all live in the URL, so a filter is a link rather than a set of instructions:</p>
