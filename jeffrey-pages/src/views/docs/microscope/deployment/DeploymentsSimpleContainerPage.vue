  ...
  <article class="docs-article">
      ...
      <div class="docs-content">
        ...
        <DocsCallout type="info">
          <strong>Multi-arch image:</strong> the <code>petrbouda/microscope</code> image ships <code>linux/amd64</code> and <code>linux/arm64</code> in a single manifest. Docker / OrbStack / containerd pull the matching variant automatically on Apple Silicon, Graviton, and other arm64 hosts.
        </DocsCallout>
