...
<template>
  <article class="docs-article">
      ...
      <div class="docs-content">
        <p>The <code>microscope-examples</code> image comes pre-loaded with sample JFR recordings and profiles. This is perfect for exploring Jeffrey's features without needing your own profiling data.</p>
