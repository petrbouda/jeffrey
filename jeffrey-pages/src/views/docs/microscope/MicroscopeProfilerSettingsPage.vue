  ...
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <DocsCallout type="info">
        <strong>Where to find it:</strong> The Profiler Settings page is accessible from the main Jeffrey Microscope navigation, separate from project-level Profiler Settings.
      </DocsCallout>
      ...
      <p>For project-specific profiler settings inside a Remote workspace, see <router-link to="/docs/microscope/projects/profiler-settings">Projects → Profiler Settings</router-link>. The same options are available there, scoped to a single project.</p>
    </div>
