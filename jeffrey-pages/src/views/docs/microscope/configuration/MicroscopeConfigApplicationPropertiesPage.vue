...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <p>
        The <code>application.properties</code> file contains essential settings for Jeffrey Microscope
        (<code>microscope.jar</code>) — the analysis tool. These are the most frequently changed properties when deploying.
      </p>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Base directory for all Jeffrey Microscope data. Env var: <code>JEFFREY_MICROSCOPE_HOME_DIR</code>
            </td>
          </tr>
          <tr>
      ...
      <DocsCallout type="tip">
        ...
        appropriate API key in <router-link to="/docs/microscope/configuration/secrets">secrets.properties</router-link>.
      </DocsCallout>
    </div>
