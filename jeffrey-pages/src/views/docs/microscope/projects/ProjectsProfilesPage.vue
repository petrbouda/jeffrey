  ...
  <article class="docs-article">
      ...
      <div class="docs-content">
        ...
        <DocsCallout type="info">
          For comprehensive information about what profiles contain and the analysis features they provide, see <router-link to="/docs/microscope/profiles">Profiles</router-link>.
        </DocsCallout>
