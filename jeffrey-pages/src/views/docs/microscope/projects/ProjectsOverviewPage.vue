  ...
  <article class="docs-article">
      ...
      <div class="docs-content">
        ...
        <div class="features-grid">
          <router-link to="/docs/microscope/projects/profiles" class="feature-card profiles">
            <div class="feature-icon"><i class="bi bi-file-earmark-text"></i></div>
            <h4>Profiles</h4>
            <p>Analyzed recordings ready for investigation</p>
          </router-link>
          <router-link to="/docs/microscope/projects/recordings" class="feature-card recordings">
            <div class="feature-icon"><i class="bi bi-record-circle"></i></div>
            <h4>Recordings</h4>
            <p>Raw JFR files uploaded to Jeffrey</p>
          </router-link>
          <router-link to="/docs/microscope/projects/repository" class="feature-card repository">
            <div class="feature-icon"><i class="bi bi-folder"></i></div>
            <h4>Repository</h4>
            <p>Recording sessions from live applications</p>
          </router-link>
          <router-link to="/docs/microscope/projects/profiler-settings" class="feature-card settings">
            <div class="feature-icon"><i class="bi bi-cpu"></i></div>
            <h4>Profiler Settings</h4>
            <p>JVM agent configuration</p>
          </router-link>
          <router-link to="/docs/microscope/projects/scheduler" class="feature-card scheduler">
            <div class="feature-icon"><i class="bi bi-calendar-check"></i></div>
            <h4>Scheduler</h4>
            <p>Automated background jobs</p>
          </router-link>
          <router-link to="/docs/microscope/projects/event-streaming" class="feature-card streaming">
