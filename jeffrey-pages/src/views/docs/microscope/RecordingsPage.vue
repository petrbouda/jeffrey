...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <p>Projects organize <strong>live applications</strong> — their instances, sessions, and configuration. Recordings is the post-capture artifact view: once a session has produced something worth keeping, you bring it here for analysis.</p>
