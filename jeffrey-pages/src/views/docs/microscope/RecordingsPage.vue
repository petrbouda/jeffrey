      ...
      <div class="workflow-steps">
        ...
        <div class="workflow-step">
          ...
          <div class="step-content">
            ...
            <p>From a project's <strong>Instances</strong> view, open a session and click <strong>Download</strong>. The session's files are streamed to local storage as they are: the JFR chunks become the files of one recording, kept chunk by chunk rather than joined, with the heap dumps and logs stored beside them, and the recording shows up tagged with its origin.</p>
