...
<template>
  <article class="docs-article">
      ...
      <div class="docs-content">
        ...
        <DocsCallout type="info">
          <strong>Scheduler job:</strong> The Session Finished Detector job runs periodically on Jeffrey Server to evaluate heartbeat staleness and detect finished sessions.
        </DocsCallout>

        <h2 id="session-cleanup">Session Cleanup</h2>
        <p>Old sessions are automatically cleaned up by Jeffrey Server scheduler jobs:</p>
        <ul>
