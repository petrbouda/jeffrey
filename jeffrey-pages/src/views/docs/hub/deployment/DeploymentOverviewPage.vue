    ...
    <div class="docs-content">
      ...
      <section class="hero">
        ...
        <div class="hero-actions">
          ...
          <router-link class="hero-cta hero-cta-ghost" to="/docs/hub/deployment/helm-chart">
      ...
      <DocsCallout type="tip">
        ...
        projects in Jeffrey Hub (<code>direct-jeffrey-testapp-server</code> and
      ...
      <div class="cluster-diagram">
        ...
        <div class="cluster-ingress">
          ...
          <small>HTTP into jeffrey-hub · gRPC for remote-workspace</small>
        </div>
      </div>
      ...
      <div class="next-grid">
        <router-link class="next-card" to="/docs/hub/deployment/jeffrey-jib">
