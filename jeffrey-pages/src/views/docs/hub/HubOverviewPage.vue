...
const headings = [
  ...
  { id: 'when-to-use-jeffrey-hub', text: 'When to Use', level: 2 }
];
    ...
    <div class="docs-content">
      ...
      <section class="hero">
        ...
        <div class="hero-actions">
          ...
          <router-link class="hero-cta hero-cta-ghost" to="/docs/hub/architecture">
      ...
      <div class="docs-grid docs-grid-2">
        ...
        <DocsFeatureCard
          ...
          title="gRPC API"
          description="Workspace, project, instance, repository and file-download services — defined by proto."
        />
        <DocsFeatureCard
          color="neutral"
        ...
        <DocsFeatureCard
          ...
          description="Many teams, many projects, one server. Each workspace owns its storage scope."
        />
      </div>

      <h2 id="when-to-use-jeffrey-hub">When to Use</h2>
