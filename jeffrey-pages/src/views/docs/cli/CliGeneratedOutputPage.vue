...
const generatedArgFileOutput = `# Jeffrey JVM arguments — generated by jeffrey-cli init
  ...
  <article class="docs-article">
      ...
      <div class="docs-content">
        ...
        <DocsCallout type="tip">
          <strong>Run the command:</strong> Execute <code>jeffrey-cli init --base-config jeffrey-init.conf</code> to generate the output files shown below.
        </DocsCallout>

        <h2 id="generated-argfile">Generated @argfile</h2>
        <p>When <code>arg-file</code> is configured, Jeffrey CLI writes a JVM arguments file with one argument per line. Use it with <code>java @/tmp/jvm.args -jar app.jar</code>:</p>
