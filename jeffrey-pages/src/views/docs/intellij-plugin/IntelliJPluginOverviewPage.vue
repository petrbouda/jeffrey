  ...
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <ul class="usecase-list">
        ...
        <li><i class="bi bi-check2-circle"></i> <strong>A recording panel in the editor</strong> — open a recording and its tab says whether Microscope has analysed it, offers the button that does, and lays the views out as tiles: flame graph, allocations, GC, threads, traces and the rest, each with a line on what the page answers. A profile that is ready adds its window, sample count, event types, sample-loss share and the auto-analysis findings — the only profile figures the plugin draws. Views the recording has no data for stay visible but dimmed, so an empty page is never a click away in disguise.</li>
