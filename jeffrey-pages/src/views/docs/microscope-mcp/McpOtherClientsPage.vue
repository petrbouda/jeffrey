...
<template>
  <article class="docs-article">
    ...
    <div class="docs-content">
      ...
      <p>For the four tools that declare an <code>outputSchema</code> &mdash; <code>profiles_list</code>, <code>profiles_evidence</code>, <code>compare_quality</code>, <code>hubs_sessions</code> &mdash; clients using protocol <code>2025-06-18</code> or newer can consume <code>structuredContent</code> and the advertised <code>outputSchema</code>. Readable text remains present. Send the negotiated <code>MCP-Protocol-Version</code> header on each request. Requests without that header receive the older text-only format. Other tools keep their existing text contract.</p>
      ...
      <p>Then <code>tools/list</code> with the same envelope returns all hundred and eleven specs. To run one:</p>
