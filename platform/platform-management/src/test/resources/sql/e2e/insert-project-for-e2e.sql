-- Insert workspace, project, repository, instance and unfinished session for end-to-end heartbeat-to-finish tests
...
VALUES ('session-001', 'repo-001', 'inst-001', 1, 'session-2025-06-15', 'cpu=true', true, '2025-06-15T08:00:00Z', '2025-06-15T08:00:01Z', NULL, NULL);
