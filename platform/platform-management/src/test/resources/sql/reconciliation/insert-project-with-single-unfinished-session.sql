-- Insert workspace, project, repository, instance with 1 unfinished session for reconciliation tests
...
VALUES ('session-001', 'repo-001', 'inst-001', 1, 'session-001', 'cpu=true', true, '2025-06-15T08:00:00Z', '2025-06-15T08:00:01Z', NULL, NULL);
