-- Insert workspace, project, repository, instance with 3 unfinished sessions for reconciliation tests
...
VALUES
    ('session-001', 'repo-001', 'inst-001', 1, 'session-001', 'cpu=true', '2025-06-15T08:00:00Z', '2025-06-15T08:00:01Z', NULL, NULL),
    ('session-002', 'repo-001', 'inst-001', 2, 'session-002', 'cpu=true', '2025-06-15T09:00:00Z', '2025-06-15T09:00:01Z', NULL, NULL),
    ('session-003', 'repo-001', 'inst-001', 3, 'session-003', 'cpu=true', '2025-06-15T10:00:00Z', '2025-06-15T10:00:01Z', NULL, NULL);
