-- Insert workspace, project, repository, instance and unfinished session for heartbeat tests
...
VALUES ('inst-001', 'proj-001', 'host-1.example.com', 'ACTIVE', '2025-06-15T10:00:00Z', NULL);
...
VALUES ('session-001', 'repo-001', 'inst-001', 1, 'session-2025-06-15', 'cpu=true', true, '2025-06-15T10:00:00Z', '2025-06-15T10:00:01Z', NULL, NULL);
