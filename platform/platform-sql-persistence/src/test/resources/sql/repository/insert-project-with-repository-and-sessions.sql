...
INSERT INTO repository_sessions (session_id, repository_id, relative_session_path, profiler_settings, finished_file, streaming_enabled, origin_created_at, created_at, finished_at)
VALUES
    ('session-001', 'repo-001', 'session-2025-01-01', 'cpu=true', 'finished.flag', false, '2025-01-01T12:00:00Z', '2025-01-01T12:00:01Z', '2025-01-01T13:00:00Z'),
    ('session-002', 'repo-001', 'session-2025-01-02', 'cpu=true,alloc=true', NULL, true, '2025-01-02T12:00:00Z', '2025-01-02T12:00:01Z', NULL);
