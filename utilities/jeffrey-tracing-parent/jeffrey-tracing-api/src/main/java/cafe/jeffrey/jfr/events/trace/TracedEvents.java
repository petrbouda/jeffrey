...
public final class TracedEvents {
    ...
    /**
     * The {@link SpanBody} of an emit with no result.
     */
    @FunctionalInterface
    ...
    public static <E extends AbstractTracedEvent, R, X extends Throwable> R emit(
            E event, SpanBody<? extends R, X> body, Filler<? super E, ? super R> filler) throws X {
    ...
    /**
     * The form of {@link #emit(AbstractTracedEvent, SpanBody, Filler)} for work with no result; the
