...
export default class ReplaceableToken {
    ...
    static FLAMEGRAPH_SEARCH = "{{REPLACE_FLAMEGRAPH_SEARCH}}"
    static FLAMEGRAPH_USE_WEIGHT = "{{REPLACE_FLAMEGRAPH_USE_WEIGHT}}"
    static FLAMEGRAPH_EVENT_TYPE = "{{REPLACE_FLAMEGRAPH_EVENT_TYPE}}"
