...
import SubSecondData from "@/service/subsecond/model/SubSecondData";
...
export default class SubSecondDataProviderImpl implements SubSecondDataProvider {
    ...
    constructor(projectId, profileId, eventType, useWeight) {
        this.baseUrl = GlobalVars.url + '/projects/' + projectId + '/profiles/' + profileId + '/subsecond'
