  ...
  <Sidebar v-model:visible="layoutState.configSidebarVisible.value" position="right"
    ...
    <template v-if="!simple">
      ...
      <div class="flex flex-wrap row-gap-3">
        ...
        <div class="flex align-items-center gap-2 w-6">
          <RadioButton name="menuMode" value="slim-plus" v-model="layoutConfig.menuMode.value"
                       inputId="mode4"></RadioButton>
          <label for="mode4">Slim+</label>
        </div>
        <div class="flex align-items-center gap-2 w-6">
          <RadioButton name="menuMode" value="reveal" v-model="layoutConfig.menuMode.value"
                       inputId="mode5"></RadioButton>
          <label for="mode5">Reveal</label>
        </div>
        <div class="flex align-items-center gap-2 w-6">
          <RadioButton name="menuMode" value="drawer" v-model="layoutConfig.menuMode.value"
                       inputId="mode6"></RadioButton>
          <label for="mode6">Drawer</label>
        </div>
        <div class="flex align-items-center gap-2 w-6">
          <RadioButton name="menuMode" value="horizontal" v-model="layoutConfig.menuMode.value"
      ...
      <div class="flex flex-wrap row-gap-3">
        <div class="flex align-items-center gap-2 w-6">
          <RadioButton name="menuTheme" value="light" v-model="layoutConfig.menuTheme.value"
                       :disabled="layoutConfig.colorScheme.value == 'dark' || isHorizontal.value"
                       inputId="menutheme-light"></RadioButton>
          <label for="menutheme-light">Light</label>
        </div>
        <div class="flex align-items-center gap-2 w-6 pl-2">
          <RadioButton name="menuTheme" value="dark" v-model="layoutConfig.menuTheme.value"
                       :disabled="layoutConfig.colorScheme == 'dark' || isHorizontal.value"
                       inputId="menutheme-dark"></RadioButton>
      ...
      <div class="flex flex-wrap row-gap-3">
        <div class="flex align-items-center gap-2 w-6">
          <RadioButton name="topbarTheme" value="light" v-model="layoutConfig.topbarTheme.value"
                       :disabled="layoutConfig.colorScheme.value == 'dark'" inputId="topbartheme-light"></RadioButton>
          <label for="topbartheme-light">Light</label>
        </div>
        <div class="flex align-items-center gap-2 w-6 pl-2">
          <RadioButton name="topbarTheme" value="dark" v-model="layoutConfig.topbarTheme.value"
                       inputId="topbartheme-dark"></RadioButton>
          <label for="topbartheme-dark">Dark</label>
        </div>
        <div class="flex align-items-center gap-2 w-6">
          <RadioButton name="topbarTheme" value="transparent" v-model="layoutConfig.topbarTheme.value"
                       inputId="topbartheme-transparent"></RadioButton>
