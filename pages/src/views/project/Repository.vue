  ...
  <div class="surface-card p-3 flex-auto xl:ml-5" v-if="currentProject">
    <div class="flex gap-5 flex-column-reverse md:flex-row">
      <div class="flex-auto p-fluid">
        <div class="surface-section" v-if="currentRepository">
          ...
          <div class="text-500 mb-5">Linked Repository is a directory with the latest recordings from the application.
            Generate a concrete recording form the repository and make a new Profile from it.
          </div>
          <ul class="list-none p-0 m-0">
            <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
              ...
              <div class="text-900 w-full md:w-10 md:flex-order-0 flex-order-1">
                ...
                <Tag severity="success" class="ml-2" value="Directory Exists"
                     v-if="currentRepository.directoryExists"></Tag>
                <Tag severity="danger" class="ml-2" value="Directory Does Not Exist"
                     v-if="!currentRepository.directoryExists"></Tag>
              </div>
            ...
            <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
              ...
              <Button label="Unlink the Repository" severity="danger" class="ml-3 w-auto"
                      @click="unlinkRepository" v-if="currentRepository"/>
            </li>
          </ul>
        </div>
        ...
        <div class="surface-section" v-if="!currentRepository ">
          ...
          <div class="text-500 mb-5">Link a directory with the latest recordings on the host, e.g. <span
              class="font-italic">/home/my-account/recordings</span></div>
          <ul class="list-none p-0 m-0">
            <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
              <div class="text-500 w-6 md:w-2 font-medium">Repository Path</div>
              <div class="text-900 w-full md:w-10 md:flex-order-0 flex-order-1">
