    ...
    <div class="ai-analysis-container">
      ...
      <div class="input-area">
        <div class="input-wrapper">
          <textarea
              ...
              :placeholder="isAvailable ? 'Ask about this heap dump...' : 'AI assistant not configured'"
      ...
      <div v-if="!hasMessages && !isLoading" class="welcome-message">
        <div class="welcome-header">
          ...
          <h3 class="welcome-title">Ask anything about your heap dump</h3>
        </div>
        <div class="example-prompts">
          <div class="prompt-section">
            <span class="prompt-section-label">
              <i class="bi bi-lightbulb"></i> Suggested prompts
            </span>
            <div class="prompt-chips">
              <button
                  ...
                  :key="index"
                  class="prompt-chip"
                  @click="useSuggestionPrompt(prompt)"
              >
                {{ prompt }}
              </button>
            </div>
...
const useSuggestionPrompt = async (text: string) => {
