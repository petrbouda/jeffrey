...
<template>
  <div class="step-header">
    <div class="step-header-status header-primary clickable-header" @click="expanded = !expanded">
    ...
    <div v-if="expanded" class="step-header-content">
...
.step-header-status .step-type-info i {
