...
package cafe.jeffrey.microscope.core.recording;
...
public class ProjectRecordingInitializer {

    @FunctionalInterface
    public interface Factory extends Function<ProjectInfo, ProjectRecordingInitializer> {
    }
    ...
    public ProjectRecordingInitializer(
            Clock clock,
     ...
     */
    public NewRecordingHolder newRecording(NewRecording recording) {
     ...
     *
     * @param newRecording    the details of the recording including filename, group ID, and input stream
