...
import cafe.jeffrey.microscope.core.resources.response.HubResponse;
...
public class HubsController {
    ...
    public ResponseEntity<HubResponse> add(@RequestBody AddRemoteServerRequest request) {
        ...
        try {
            HubClients clients = remoteClientsFactory.apply(address);
            DiscoveryClient.PublicApiInfo info = clients.discovery().info();
