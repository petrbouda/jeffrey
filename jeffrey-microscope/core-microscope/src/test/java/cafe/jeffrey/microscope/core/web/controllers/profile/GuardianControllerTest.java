...
class GuardianControllerTest {
    ...
    void listsEmpty() {
        ...
        when(guardianManager.guardResults()).thenReturn(List.of());

        MockMvcTester mvc = mockMvcTesterFor(new GuardianController(resolver));

        assertThat(mvc.get().uri("/api/internal/profiles/p-1/guardian"))
                .hasStatusOk()
                .bodyJson()
    ...
    void profileNotFoundReturns404() {
        ...
        assertThat(mvc.get().uri("/api/internal/profiles/ghost/guardian"))
                .hasStatus(404)
                .bodyJson()
