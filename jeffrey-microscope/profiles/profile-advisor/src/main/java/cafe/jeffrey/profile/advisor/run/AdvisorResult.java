 ...
 * profile, the human-readable {@code recommendations} markdown (analysis + rationale, no diffs), and
 * the {@code patch} implementing them.
 *
 ...
 */
public record AdvisorResult(Severity severity, String recommendations, String patch) {
