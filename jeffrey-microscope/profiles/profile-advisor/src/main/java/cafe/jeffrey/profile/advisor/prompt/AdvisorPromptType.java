...
public enum AdvisorPromptType {
    ...
    AdvisorPromptType(String label, String slug, Type... eventTypes) {
        this.label = label;
        this.slug = slug;
    ...
    public static Optional<AdvisorPromptType> byEventCode(String eventCode) {
        return Arrays.stream(values())
    ...
    public static Optional<AdvisorPromptType> byFileName(String fileName) {
