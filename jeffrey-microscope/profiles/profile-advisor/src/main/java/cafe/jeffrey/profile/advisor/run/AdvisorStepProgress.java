...
/**
 * The live progress of one timed step (Prompt / Source / Analyze / Ground) within an event type's run,
 ...
 *
 * @param step       the pipeline step name (an {@link AdvisorStatus} name, e.g. {@code ANALYZING})
