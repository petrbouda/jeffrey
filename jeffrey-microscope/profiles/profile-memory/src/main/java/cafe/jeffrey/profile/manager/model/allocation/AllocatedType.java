...
/**
 * Allocation totals for one class, derived from the allocation events.
 *
 * @param className class of the allocated objects
 * @param bytes     total allocated bytes attributed to this class
