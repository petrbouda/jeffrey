...
// re-exporting them is fragile. Re-exported deliberately: this module exists to hand other modules
// a configured ChatClient, so ChatClient and the model types are its exported API.
