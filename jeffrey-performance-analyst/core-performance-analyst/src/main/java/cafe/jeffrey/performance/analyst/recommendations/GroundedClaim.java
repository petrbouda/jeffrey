...
/**
 * A {@link RecommendationClaim} after it has been checked against the evidence: the measured frame it
 ...
 */
public record GroundedClaim(RecommendationClaim claim, ProfileFrame frame, boolean sourceFound) {

    public boolean grounded() {
        return frame != null;
    }

    public static GroundedClaim ungrounded(RecommendationClaim claim) {
