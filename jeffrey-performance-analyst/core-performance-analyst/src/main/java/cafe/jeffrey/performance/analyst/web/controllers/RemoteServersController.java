...
import cafe.jeffrey.performance.analyst.resources.response.RemoteServerResponse;
...
public class RemoteServersController {
    ...
    public ResponseEntity<RemoteServerResponse> add(@RequestBody AddRemoteServerRequest request) {
        ...
        try {
            RemoteDiscoveryClient.PublicApiInfo info = remoteConnections.discovery(address).info();
