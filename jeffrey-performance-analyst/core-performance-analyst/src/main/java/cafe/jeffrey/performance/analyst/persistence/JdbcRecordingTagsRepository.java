...
/**
 * SQLite-backed {@link RecordingTagsRepository} for the performance-analyst store. Tags carry no
 * timestamps, so this mirrors microscope's DuckDB implementation verbatim.
 */
