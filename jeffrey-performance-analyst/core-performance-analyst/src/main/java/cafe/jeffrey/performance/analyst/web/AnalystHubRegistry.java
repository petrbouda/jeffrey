...
/**
 * Performance Analyst's {@link HubRegistry} bridge over its local {@link HubsManager}.
 */
public class AnalystHubRegistry implements HubRegistry {

    private final HubsManager hubsManager;

    public AnalystHubRegistry(HubsManager hubsManager) {
