...
/**
 * gRPC client for discovering workspaces and projects on a remote jeffrey-server.
 * Copied (trimmed) from jeffrey-microscope — it only covers the discovery surface
 * (workspaces + projects + API-version handshake) and has no profile/recording coupling.
 */
