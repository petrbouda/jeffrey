...
import pbouda.jeffrey.provider.profile.query.CachingFlamegraphRecordWithThreadsRowMapper;
...
public class FlamegraphByThreadBenchmark {
     ...
     * <pre>
     * java -cp target/benchmarks.jar pbouda.jeffrey.jmh.flamegraph.ByThreadFlamegraphBenchmark
     * </pre>
     */
