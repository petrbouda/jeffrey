...
/**
 * Optimized row mapper for simple flamegraph query that resolves frames using a pre-loaded cache.
 * Works with SIMPLE_OPTIMIZED query that returns: stacktrace_hash, frame_hashes, total_samples, total_weight.
 * No thread info or weight_entity.
 */
public record OptimizedSimpleFlamegraphRecordRowMapper(
        Type eventType,
