...
/**
 * Row mapper for the simple flamegraph query (SQL-side frame resolution).
 * Works with SIMPLE query that returns: stacktrace_hash, frames, total_samples, total_weight.
 * No thread info or weight_entity.
 */
public record SimpleFlamegraphRecordRowMapper(Type eventType) implements RowMapper<FlamegraphRecord> {
