...
import cafe.jeffrey.provider.profile.query.CachingFlamegraphRecordRowMapper;
...
public class FlamegraphSimpleBenchmark {
     ...
     * <pre>
     * java -cp jmh-tests/target/benchmarks.jar cafe.jeffrey.jmh.flamegraph.FlamegraphSimpleBenchmark
     * </pre>
     */
