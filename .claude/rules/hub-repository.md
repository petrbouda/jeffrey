...
- `shared/common` holds utilities and hub↔provisioner contract types only (`RemoteProject*`, `ProfilerSettingsSource`, `RepositoryType`, `JeffreyLayout`, `ChunkWindow`). Never put a domain record there.
