...
- Location: `shared/hub-api/src/main/proto/jeffrey/hub/api/v1/` — `workspace_service`, `project_service`, `instance_service`, `file_download_service`, `repository_service`, `scoped_config_service`, plus `common` for enums two services share. Protos only; no Java in that module.
